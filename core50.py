...
if __name__ == "__main__":
    ...
    for mode in ['test']:
        ...
        print('\nFinal {} Accuracy: {:.5f} +/- {:.3f}'.format(mode, final_acc_avg, final_acc_se))
        print('\nFinal {} Forget: {:.5f} +/- {:.3f}'.format(mode, final_forget_avg, final_forget_se))
        print('\nFinal {} LA: {:.5f} +/- {:.3f}'.format(mode, final_la_avg, final_la_se))
